        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="glass-panel p-8 relative z-10 hover:z-50 transition-all duration-300">
            ...
            <div className="flex flex-wrap gap-4 items-center">
              ...
              <Keyword word="React.js / React 18" logo="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/react/react-original.svg" />
              ...
              <Keyword word="CSS3" logo="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/css3/css3-original.svg" />
            </div>
          </div>
          ...
          <div className="glass-panel p-8 relative z-10 hover:z-50 transition-all duration-300">
            ...
            <div className="flex flex-wrap gap-4 items-center">
              ...
              <Keyword word="REST API Design" />
              <Keyword word="Socket.IO" logo="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/socketio/socketio-original.svg" />
              <Keyword word="SQLAlchemy" logo="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/sqlalchemy/sqlalchemy-original.svg" />
